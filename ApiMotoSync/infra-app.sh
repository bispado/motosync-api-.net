...
BEGIN
  EXECUTE IMMEDIATE q'[
    ALTER TABLE "USUARIOS" ADD ("Email" NVARCHAR2(180))
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE IN (-1430, -01442) THEN NULL; ELSE RAISE; END IF;
END;
/

BEGIN
  EXECUTE IMMEDIATE q'[
    UPDATE "USUARIOS" SET "Email" = 'desconhecido-' || RAWTOHEX("Id")
    WHERE "Email" IS NULL
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE = -904 THEN NULL; ELSE RAISE; END IF;
END;
/

BEGIN
  EXECUTE IMMEDIATE q'[
    ALTER TABLE "USUARIOS" ADD ("Cargo" NVARCHAR2(80))
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE IN (-1430, -01442) THEN NULL; ELSE RAISE; END IF;
END;
...
BEGIN
  EXECUTE IMMEDIATE q'[
    UPDATE "USUARIOS" SET "Cargo" = NVL("Cargo", 'Gestor')
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE = -904 THEN NULL; ELSE RAISE; END IF;
END;
...
BEGIN
  EXECUTE IMMEDIATE q'[
    ALTER TABLE "USUARIOS" MODIFY ("Email" NVARCHAR2(180) NOT NULL)
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE = -1440 THEN NULL; ELSE RAISE; END IF;
END;
/

BEGIN
  EXECUTE IMMEDIATE q'[
    ALTER TABLE "USUARIOS" MODIFY ("Cargo" NVARCHAR2(80) NOT NULL)
  ]';
EXCEPTION
  WHEN OTHERS THEN IF SQLCODE = -1440 THEN NULL; ELSE RAISE; END IF;
END;
